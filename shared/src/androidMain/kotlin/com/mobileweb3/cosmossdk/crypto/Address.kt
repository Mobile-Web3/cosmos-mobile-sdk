...
actual object Address {
    ...
    private fun createKeyWithPathFromEntropy(
        ...
        val masterKey = HDKeyDerivation.createMasterPrivateKey(
            Entropy.getHDSeed(Utils.hexStringToByteArray(entropy))
        )
    ...
    private fun getDpAddress(
        ...
        val hash = digest.digest(Utils.hexStringToByteArray(pubHex))
    ...
    private fun polymod(values: ByteArray): Int {
        ...
        for (b in values) {
            ...
            chk = (b xor ((chk and 0x1ffffff shl 5).toByte())).toInt()
            for (i in 0..4) {
